...
def _read_field_unescaped_from_msg(
        msg: "Message", field: str) -> Optional[str]:
...
def read_pkg_file(self, file):
    ...
    if self.long_description is None and self.metadata_version >= StrictVersion(
            '2.1'):
...
def single_line(val):
    ...
    if '\n' in val:
        # TODO after 2021-07-31: Replace with `raise ValueError("newlines not
        # allowed")`
