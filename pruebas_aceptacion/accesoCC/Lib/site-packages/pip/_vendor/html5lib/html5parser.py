...
def parseFragment(doc, container="div", treebuilder="etree",
...
class HTMLParser(object):
    ...
    def _parse(self, stream, innerHTML=False,
               container="div", scripting=False, **kwargs):
    ...
    def isHTMLIntegrationPoint(self, element):
        if (element.name == "annotation-xml" and
            ...
            return (element.namespace,
                    element.name) in htmlIntegrationPointElements

    def isMathMLTextIntegrationPoint(self, element):
        return (element.namespace,
                element.name) in mathmlTextIntegrationPointElements
...
def getPhases(debug):
    ...
    class Phase(with_metaclass(getMetaclass(debug, log))):
        ...
        def processStartTag(self, token):
            ...
            if name in self.__startTagCache:
                ...
                while len(self.__startTagCache) > len(
                        self.startTagHandler) * 1.1:
                    # this makes the eviction policy random on Py < 3.7 and
                    # FIFO >= 3.7
    ...
    class InCaptionPhase(Phase):
        ...
        def startTagTableElement(self, token):
            self.parser.parseError()
            # XXX Have to duplicate logic here to find out if the tag is
            # ignored
